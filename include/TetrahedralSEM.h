...
protected:
    ...
    std::vector<std::string> path_quadInfo{"../quad_info/quad_info_1d_p38.dat",
					   "../quad_info/quad_2d_deg26_n130.dat",
					   "../quad_info/quad_3d_deg26_n923.dat"};
    std::string path_interpInfo = "../quad_info/Info_Interpolate_More";
    std::string path_1DQuadInfo = "../quad_info/qinfo_1d/";
...
public:
    ...
    void build_mass_V_matrix(std::vector<unsigned int> &n_nonzero_per_row_mass_V, SparsityPattern &sp_pattern, SparseMatrix<valuetype> &sp_matrix,
			     FEMSpace<double, 3> &fem_space, double(*func)(double*));
    
    void calc_rhs(Vector<valuetype> &rhs, std::vector<std::vector<valuetype> > &value_f);
    void calc_rhs(Vector<valuetype> &rhs, FEMSpace<double, 3> &fem_space, double(*func)(double*));
    void calc_rhs(Vector<valuetype> &rhs, FEMSpace<double, 3> &fem_space, double(*func)(double*, double), double t);
    ...
    void impose_boundary_condition(SparseMatrix<valuetype> &sp_matrix, Vector<valuetype> &rhs,
				   RegularMesh<3> &mesh, valuetype(*func)(valuetype*),
				   bool flag_modify_matrix, unsigned int flag_boundary = 1);
    void impose_boundary_condition(Vector<double>& rhs, RegularMesh<3>& mesh, valuetype(*func)(valuetype*), unsigned int flag_boundary = 2); // impose nuemann boundary condition
    void impose_boundary_condition(SparseMatrix<valuetype> &sp_matrix, Vector<valuetype> &rhs,
				   Mesh<3>& mesh, valuetype(*func)(valuetype*),
				   bool flag_modify_matrix, int flag_boundary = 1);
    
    void impose_mask(RegularMesh<3> &mesh, FEMSpace<double, 3> &fem_space, valuetype(*func)(valuetype*), std::vector<Vector<valuetype> > &psi);
    ...
    valuetype calc_l2_error(Vector<valuetype> &sol, FEMSpace<double, 3> &fem_space, valuetype (*func)(valuetype *));
    valuetype calc_l2_error(Vector<valuetype> &sol, FEMSpace<double, 3> &fem_space, valuetype (*func)(valuetype *, valuetype), valuetype t);
    ...
    valuetype calc_l2_error_gradient(RegularMesh<3> &mesh, FEMSpace<double, 3> &fem_space,
				     Vector<valuetype> &sol, void (*func)(valuetype *, valuetype *));
    valuetype calc_h1_error(RegularMesh<3> &mesh, FEMSpace<double, 3> &fem_space,
			    Vector<valuetype> &sol, valuetype (*func)(valuetype *), void (*func_g)(valuetype *, valuetype *));
    ...
    valuetype calc_l2_gradient(Mesh<3>& mesh, Vector<valuetype>& u, unsigned int idx_ele);
    valuetype calc_l2_error_component(Vector<valuetype> &u, int polynomial_order_less, int polynomial_order_more);
    valuetype calc_l2_error_component(Vector<valuetype> &u, int polynomial_order_less, int polynomial_order_more, unsigned int idx_ele);
    ...
    void calc_interpolation(Vector<valuetype> &interp, RegularMesh<3> &mesh, FEMSpace<double, 3> &fem_space, double(*func)(double*));
    void calc_interpolation(Vector<valuetype> &interp, Mesh<3> &mesh, FEMSpace<double, 3> &fem_space, double(*func)(double*));
    void calc_interpolation(Vector<valuetype> &interp, RegularMesh<3> &mesh, FEMSpace<double, 3> &fem_space, double(*func)(double*, double), double t);
...
void THIS_TSEM::build_quad_info(int qinfo_order)
{
    ...
    QPoint.resize(n_q_point[2]);
    QPoint_Barycentric.resize(2);
    for (unsigned int idx = 0; idx < 2; ++idx) QPoint_Barycentric[idx].resize(n_q_point[idx], std::vector<double> (idx+2));
    Weight.resize(3);
	...
	for (unsigned int idx2_qp = 0; idx2_qp < n_qp_1d; ++idx2_qp){
	    ...
	    std::vector<double> &p1_1d = QPoint_Barycentric[0][idx1_qp];
	    std::vector<double> &p2_1d = QPoint_Barycentric[0][idx2_qp];
	    std::vector<double> &p_2d  = QPoint_Barycentric[1][idx_qp_2d];
	...
	for (unsigned int idx2_qp = 0; idx2_qp < n_qp_1d; ++idx2_qp)
		...
		std::vector<double> &p1_1d = QPoint_Barycentric[0][idx1_qp];
		std::vector<double> &p2_1d = QPoint_Barycentric[0][idx2_qp];
		std::vector<double> &p3_1d = QPoint_Barycentric[0][idx3_qp];
...
TEMPLATE_TSEM
void THIS_TSEM::calc_rhs(Vector<valuetype> &rhs, FEMSpace<double, 3> &fem_space, double(*func)(double*))
{
    rhs.reinit(n_dof_total);
    for (int ind_dof = 0; ind_dof < n_dof_total; ++ind_dof) rhs(ind_dof) = 0;
...
TEMPLATE_TSEM
void THIS_TSEM::calc_rhs(Vector<valuetype> &rhs, FEMSpace<double, 3> &fem_space, double(*func)(double*, double), double t)
{
    rhs.reinit(n_dof_total);
    for (int ind_dof = 0; ind_dof < n_dof_total; ++ind_dof) rhs(ind_dof) = 0;
    std::vector<double> value_f(n_q_point[2]);
...
void THIS_TSEM::impose_boundary_condition(SparseMatrix<valuetype> &sp_matrix, Vector<valuetype> &rhs,
					  Mesh<3>& mesh, valuetype(*func)(valuetype*),
					  bool flag_modify_matrix, int flag_boundary)
{
    const SparsityPattern &sp_pattern = sp_matrix.get_sparsity_pattern();
    const std::size_t *row_start = sp_pattern.get_rowstart_indices();
    const unsigned int *col_nums = sp_pattern.get_column_numbers();
...
TEMPLATE_TSEM
void THIS_TSEM::impose_boundary_condition(Vector<double>& rhs, RegularMesh<3>& mesh, valuetype(*func)(valuetype*), unsigned int flag_boundary)
...
TEMPLATE_TSEM
void THIS_TSEM::impose_mask(RegularMesh<3> &mesh, FEMSpace<double, 3> &fem_space, valuetype(*func)(valuetype*), std::vector<Vector<valuetype> > &psi)
{    
    ...
    std::vector<double> val_interp3(n_q_point[2]), val_psi_re3(n_q_point[2]), val_psi_im3(n_q_point[2]);
...
void THIS_TSEM::calc_val_gradient_qp_onElement(Vector<valuetype> &src, std::vector<std::vector<double> > &dst, RegularMesh<3> &mesh, unsigned int idx_ele)
{
    ...
    std::vector<double> val_coef(n_index);
...
TEMPLATE_TSEM
valuetype THIS_TSEM::calc_l2_error(Vector<valuetype> &sol, FEMSpace<double, 3> &fem_space, valuetype (*func)(valuetype *))
{
    valuetype err_l2 = 0;
...
TEMPLATE_TSEM
valuetype THIS_TSEM::calc_l2_error(Vector<valuetype> &sol, FEMSpace<double, 3> &fem_space, valuetype (*func)(valuetype *, valuetype), valuetype t)
{
    valuetype err_l2 = 0;
    std::vector<valuetype> value_exact(n_q_point[2]);
    for (int ind_ele = 0; ind_ele < n_element; ++ind_ele){
...
TEMPLATE_TSEM
valuetype THIS_TSEM:: calc_l2_gradient(Mesh<3>& mesh, Vector<valuetype> &u, unsigned int idx_ele)
{
    valuetype err = (valuetype) 0;
    // recover local coefficient on this element
    std::vector<valuetype> val_coef(n_index);
    calc_coef_onElement(u, val_coef, idx_ele);
    ...
    err = sqrt(count * val_volume[idx_ele]);
    return err;
    // return count;
}
...
TEMPLATE_TSEM
valuetype THIS_TSEM::calc_l2_error_component(Vector<valuetype> &u, int polynomial_order_less, int polynomial_order_more, unsigned int idx_ele)
{ // calcultate L2 error between polynomial_order_less and polynomial_order_large,
  // suppose polynomial_order_less < polynomial_order_more <= M
    valuetype err_l2 = 0;
    std::vector<bool> flag_less(n_index, true);
    ...
    err_l2 += count * val_volume[idx_ele];
    err_l2 = sqrt(err_l2);
...
TEMPLATE_TSEM
void THIS_TSEM::calc_interpolation(Vector<valuetype> &interp, RegularMesh<3> &mesh, FEMSpace<double, 3> &fem_space, double(*func)(double*))
{
    interp.reinit(n_dof_total);
...
TEMPLATE_TSEM
void THIS_TSEM::calc_interpolation(Vector<valuetype> &interp, Mesh<3> &mesh, FEMSpace<double, 3> &fem_space, double(*func)(double*))
{
    interp.reinit(n_dof_total);
...
TEMPLATE_TSEM
void THIS_TSEM::calc_interpolation(Vector<valuetype> &interp, RegularMesh<3> &mesh, FEMSpace<double, 3> &fem_space, double(*func)(double*, double), double t)
{
    interp.reinit(n_dof_total);
...
TSEMVisualize<valuetype>::TSEMVisualize() :
...
template<typename valuetype>
void TSEMVisualize<valuetype>::read(TSEM<valuetype>* p_tsem, HGeometryTree<3>* hg_tree, Vector<valuetype>* solution)
{
    tsem = p_tsem; h_tree = hg_tree; sol = solution;
    flag_interp = 1;
}
template<typename valuetype>
void TSEMVisualize<valuetype>::read(TSEM<valuetype>* p_tsem, HGeometryTree<3>* hg_tree, std::vector<Vector<valuetype> >* wave_function, std::vector<valuetype>* n_occupation)
{
...
template<typename valuetype>
void TSEMVisualize<valuetype>::build()
{
...
template<typename valuetype>
void TSEMVisualize<valuetype>::interp()
{
...
template<typename valuetype>
void TSEMVisualize<valuetype>::get_indicator()
{
    val_indicator.resize(irregular_mesh->regularMesh().n_geometry(3), 1);
}

template<typename valuetype>
void TSEMVisualize<valuetype>::smooth_indicator()
{
    RegularMesh<3>& mesh = irregular_mesh->regularMesh();
...
template<typename valuetype>
void TSEMVisualize<valuetype>::write(std::string filename_output)
{
    irregular_mesh->semiregularize(); irregular_mesh->regularize(false);
    RegularMesh<3>& mesh = irregular_mesh->regularMesh();
...
template<typename valuetype>
void TSEMVisualize<valuetype>::write(std::string filename_mesh, std::string filename_output)
{
    Mesh<3> mesh;
